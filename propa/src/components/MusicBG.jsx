...
import mp3_3 from "../assets/music/Rat.mp3";
import mp3_2 from "../assets/music/Wine.mp3";
import mp3_1 from "../assets/music/Brixton.mp3";
...
const MusicBG = () => {
  ...
  const songs = useRef([mp3_1, mp3_2, mp3_3]);
